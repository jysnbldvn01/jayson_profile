...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      {/* suppressHydrationWarning here silences mismatches caused by browser
          extensions (e.g. ColorZilla's cz-shortcut-listen) injecting attributes
          onto <body> before React hydrates — it does not hide real bugs since
          it only scopes to this element's own attributes. */}
