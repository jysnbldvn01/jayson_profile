    ...
    <div className="flex items-center justify-center">
      <ResponsiveDialog>
        ...
        <ResponsiveDialogContent className="md:max-w-4xl md:h-[85vh] md:!flex md:flex-col md:overflow-hidden md:p-0 md:gap-0">
          {/* Radix requires a DialogTitle (and warns about a missing Description too)
              for screen readers. The visible header below is purely decorative, so
              we provide the real ones here but visually hide them via sr-only. */}
